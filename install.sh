...
sudo apt-get install i3 i3blocks dmenu feh xautolock redshift gtk-redshift autokey autokey-gtk zsh git ripgrep tree xclip xsel htop ipython3 scrot colordiff emacs global
